...
class ViewReservationsDisapproved extends StatefulWidget {
  const ViewReservationsDisapproved({super.key});

  @override
  State<ViewReservationsDisapproved> createState() => _ViewReservationsDisapprovedState();
}

class _ViewReservationsDisapprovedState extends State<ViewReservationsDisapproved> {
        ...
        title: Center(
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: 10,),
              const Text("Disapproved Room Reservations", style: TextStyle(fontWeight: FontWeight.bold),),
            ],
          )),
      ),
